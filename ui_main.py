    ...
    def setupUi(self, MainWindow):
        ...
        for line in f.readlines():
            ...
            if line[0] == 'btc':
                ...
                print(line)
                self.eth_holdnum = float(line[1])
            elif line[0]=='doge':
                print(line)
                self.doge_holdnum = float(line[1])
        f.close()

        self.last_btc_price = 0
        self.last_eth_price = 0
        self.last_doge_price = 0
        self.last_all_price = 0
...
"}")
        ...
        self.page_home.setStyleSheet("background-image:url(background.png);")
        ...
        self.page_person.setObjectName(u"page_person")
        self.stackedWidget.addWidget(self.page_person)


        # layout
        self.verticalLayout_person = QVBoxLayout(self.page_person)
        self.verticalLayout_person.setObjectName(u"verticalLayout_person")
        self.verticalLayout_person.setContentsMargins(0,10,100,0)
        self.verticalLayout_person.setSpacing(5)



        self.label_person = QLabel(self.page_person)
        self.label_person.setObjectName(u"person")
        font6 = QFont()
        ...
        self.label_btc_num.setObjectName(u"btc")
        font6 = QFont()
        font6.setFamily(u"Segoe UI")
        font6.setPointSize(14)
        ...
        self.label_btc.setObjectName(u"label")
        font6 = QFont()
        font6.setFamily(u"Segoe UI")
        font6.setPointSize(18)
        self.label_btc.setFont(font6)
        self.label_btc.setAlignment(Qt.AlignCenter)
        self.label_btc.setStyleSheet("background:transparent;")
        self.verticalLayout_10.addWidget(self.label_btc)

        self.label_eth = QLabel(self.page_home)
        self.label_eth.setObjectName(u"label")
        font6 = QFont()
        font6.setFamily(u"Segoe UI")
        font6.setPointSize(18)
        self.label_eth.setFont(font6)
        self.label_eth.setAlignment(Qt.AlignCenter)
        self.label_eth.setStyleSheet("background:transparent;")
        self.verticalLayout_10.addWidget(self.label_eth)

        self.label_doge = QLabel(self.page_home)
        self.label_doge.setObjectName(u"label")
        font6 = QFont()
        font6.setFamily(u"Segoe UI")
        font6.setPointSize(18)
        self.label_doge.setFont(font6)
        self.label_doge.setAlignment(Qt.AlignCenter)
        self.label_doge.setStyleSheet("background:transparent;")
        self.verticalLayout_10.addWidget(self.label_doge)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_user_icon.setText(QCoreApplication.translate("MainWindow", u"MU", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"CRYPTO TOOL", None))
        #self.label_btc.setText(QCoreApplication.translate("MainWindow", u"Btc $40000", None))
        #self.label_eth.setText(QCoreApplication.translate("MainWindow", u"ETH $40000", None))
    ...
    def btcPriceChange(self,data):
        ...
        data = round(data,2)
        data = str(data)
        self.label_btc.setText(QCoreApplication.translate("MainWindow", u"Btc    $:"+data, None))

    def topPriceChange(self,data):
        all_worth = 0
        data_btc = data.split('/')[0]
        data_btc = float(data_btc)
        if data_btc>self.last_btc_price:
            btc_status = "green"
        else:
            btc_status = "red"
        self.last_btc_price = data_btc
        worth = self.btc_holdnum*data_btc
        worth = round(worth, 2)
        all_worth+=worth
        worth = str(worth)
        holdnum = round(self.btc_holdnum, 2)
        holdnum = str(holdnum)
        self.label_btc_num.setText(QCoreApplication.translate("MainWindow", u"Btc:"+holdnum+"$:" + '<font color='+btc_status+'>'+worth+'</font>', None))
        data_btc = round(data_btc, 2)
        data_btc = str(data_btc)
        self.label_btc.setText(QCoreApplication.translate("MainWindow", u"Btc    $:" + '<font color='+btc_status+'>'+data_btc+'</font>', None))
        #eth
        data_eth = data.split('/')[1]
        data_eth = float(data_eth)
        if data_eth>self.last_eth_price:
            eth_status = "green"
        else:
            eth_status = "red"
        self.last_eth_price = data_eth
        worth = self.eth_holdnum * data_eth
        worth= round(worth, 2)
        all_worth += worth
        worth = str(worth)
        holdnum = round(self.eth_holdnum, 2)
        holdnum = str(holdnum)
        self.label_eth_num.setText(
        QCoreApplication.translate("MainWindow", u"Eth:" + holdnum + "$:" + '<font color='+eth_status+'>'+worth+'</font>', None))
        data_eth = round(data_eth, 2)
        data_eth = str(data_eth)
        self.label_eth.setText(QCoreApplication.translate("MainWindow", u"Eth    $:" + '<font color='+eth_status+'>'+data_eth+'</font>', None))
        # doge
        data_doge = data.split('/')[2]
        data_doge = float(data_doge)
        if data_doge>self.last_doge_price:
            doge_status = "green"
        else:
            doge_status = "red"
        ...
        if all_worth>self.last_all_price:
            all_worth_status = "green"
        else:
            all_worth_status = "red"
