...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.cryptoTool = PriceThread()
        self.cryptoTool.init()
        self.cryptoTool.signal.connect(self.onPrice)
        self.cryptoTool.start()
        ...
        ## SET ==> WINDOW TITLE
        self.setWindowTitle('Crpyto Tool')
        UIFunctions.labelTitle(self, 'Crypto Tool price')
        UIFunctions.labelDescription(self, '加密貨幣工具')
        ## ==> END ##
        ...
        ## USER ICON ==> SHOW HIDE
        UIFunctions.userIcon(self, "MU", "", True)
        ## ==> END ##
